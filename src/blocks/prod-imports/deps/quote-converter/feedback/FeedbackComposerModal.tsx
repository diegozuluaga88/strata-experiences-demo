...
// Ports the "Send feedback" modal from production · dev-strata.orderbahn.com/quote-converter/.
// Source · Diego screenshots 2026-06-26 + PRD Fase B enhancements:
// - FB-11 · auto-attach doc context cuando abre desde DocumentReviewModal
// - FB-13 · suggested issues quick-select chips por category
// - FB-12 · paste-screenshot listener (clipboard image → base64 attachment)
...
export default function FeedbackComposerModal({
    ...
    // FB-12 · Paste-screenshot listener · clipboard image while modal open.
    useEffect(() => {
        if (!isOpen) return
